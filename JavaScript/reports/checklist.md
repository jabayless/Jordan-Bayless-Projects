...
* Are the simplest and least data intensive data structures used?
...
* Be sure that exceptions and errors are handled and logged properly. 
* If the method returns an error code, check that if it describes the error properly.
